...
const ProductPage = ({ navigateTo }) => {
  ...
  const products = [
    ...
    {id:5, name: "OMNİTRİX", brand: "Azmut Ltd", price: "1 dürüüm ayran", image: "https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcSMgjj3ZZHslBL8KD4FZTbhgYjBW_CZfSwQZNEO4IBr7qnoeMOHsK5quRO_Zw5Q"}
  ];
